...
public class Account implements Serializable {
    ...
    @Basic(optional = false)
    @Column(name = "[Create Date]", nullable = false, length = 10)
    ...
    public Account(String userID, String password, String name, int phone, String address, String createDate, String role) {
        this.userID = userID;
    ...
    public Account(String userID, String password, String name, int phone, String address, String createDate, String role, Status status) {
        this.userID = userID;
        this.password = password;
        this.name = name;
        this.phone = phone;
    ...
    public String toString() {
        return "khoilda.db.Account[ userID=" + userID + " ]";
    }
