...
public class BookingDetail implements Serializable {
    ...
    public BookingDetail(Integer bookingDetailID, int quantity, int total) {
        this.bookingDetailID = bookingDetailID;
        this.quantity = quantity;
        this.total = total;
    }

    public BookingDetail(Integer bookingDetailID, int quantity, int total, Booking bookingID, Room roomID) {
        this.bookingDetailID = bookingDetailID;
        this.quantity = quantity;
        this.total = total;
    ...
    public BookingDetail(Integer bookingDetailID, int quantity, int total, Room roomID) {
        this.bookingDetailID = bookingDetailID;
        this.quantity = quantity;
        this.total = total;
        this.roomID = roomID;
    ...
    public String toString() {
        return "khoilda.db.BookingDetail[ bookingDetailID=" + bookingDetailID + " ]";
    }
